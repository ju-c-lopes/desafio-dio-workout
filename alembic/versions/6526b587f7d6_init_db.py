...
Revision ID: 6526b587f7d6
Revises: 
Create Date: 2024-07-06 12:03:27.597190
...
def upgrade() -> None:
    ...
    sa.Column('ccentro_treinamento_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['ccentro_treinamento_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
